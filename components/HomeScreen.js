    ...
    <ImageBackground source={require('../assets/BG-HomeScreen.png')} style={styles.background}>
      <View style={styles.container}>
        ...
        <View style={styles.buttonContainer}>
          <TouchableOpacity style={styles.playButton} onPress={() => navigation.navigate('PlayScreen')}>
        ...
        <View style={styles.bottomContainer}>
          ...
          <View style={styles.bottomButtonsContainer}>
            <TouchableOpacity style={styles.bottomButton} onPress={() => navigation.navigate('StatScreen')}>
              <Text style={styles.bottomButtonText}>STAT</Text>
            </TouchableOpacity>
            <TouchableOpacity style={styles.bottomButton} onPress={() => navigation.navigate('SettingScreen')}>
...
const styles = StyleSheet.create({
 ...
 bottomContainer: {
    ...
    left: 0,
    right: 0,
    backgroundColor: 'linear-gradient(0deg, rgba(255,255,255,0) 0%, rgba(255,255,255,1) 100%)',
    padding: 20,
    marginBottom: 30,
  },
